    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        if (!context.Response.Headers.ContainsKey(nameSecurityPolicy))
        {
            context.Response.Headers.Add(nameSecurityPolicy,
                ...
                "connect-src 'self' 'unsafe-inline' http://localhost:62224 https://209.145.54.249:7201 https://vmi531999.contaboserver.net:7201 http://localhost:58560 ws://localhost:58560 wss://localhost:44351 wss://localhost:44390 ws://localhost:62224 wss://localhost:44331 ws://localhost:50059 http://localhost:50059 wss://localhost:44374 http://localhost:50087 ws://localhost:50087 wss://localhost:44334;" +
