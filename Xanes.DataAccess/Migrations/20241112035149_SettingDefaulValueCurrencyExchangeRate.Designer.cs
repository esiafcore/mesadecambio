...
namespace Xanes.DataAccess.Migrations
{
    ...
    [Migration("20241112035149_SettingDefaulValueCurrencyExchangeRate")]
    partial class SettingDefaulValueCurrencyExchangeRate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Xanes.Models.BankAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("LiteralPrefix")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)")
                        .HasColumnName("literalprefix");
                    ...
                    b.HasIndex("CurrencyId")
                        .HasDatabaseName("ix_banksaccounts_currencyid");

                    b.HasIndex("ParentId")
                        .HasDatabaseName("ix_banksaccounts_parentid");

                    b.HasIndex(new[] { "CompanyId", "ParentId", "Code" }, "banksaccounts_idx_2010")
                        .IsUnique()
                        .HasDatabaseName("ix_banksaccounts_companyid_parentid_code");

                    b.ToTable("banksaccounts", "bco");
                });

            modelBuilder.Entity("Xanes.Models.BusinessExecutive", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_businessexecutives");

                    b.HasIndex(new[] { "CompanyId", "Code" }, "businessexecutives_idx_2010")
                        .IsUnique()
                        .HasDatabaseName("ix_businessexecutives_companyid_code");

                    b.ToTable("businessexecutives", "cxc");
                });
            ...
            modelBuilder.Entity("Xanes.Models.CurrencyExchangeRate", b =>
                {
                    ...
                    b.Property<decimal>("BuyRateOrigin")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 8)
                        .HasColumnType("decimal(18,8)")
                        .HasDefaultValue(0m)
                        .HasColumnName("buyrateorigin");
                    ...
                    b.Property<decimal>("OfficialRateOrigin")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 8)
                        .HasColumnType("decimal(18,8)")
                        .HasDefaultValue(0m)
                        .HasColumnName("officialrateorigin");
                    ...
                    b.Property<decimal>("SellRateOrigin")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 8)
                        .HasColumnType("decimal(18,8)")
                        .HasDefaultValue(0m)
                        .HasColumnName("sellrateorigin");
            ...
            modelBuilder.Entity("Xanes.Models.Customer", b =>
                {
                    ...
                    b.Property<int?>("BusinessExecutiveId")
                        .HasColumnType("int")
                    ...
                    b.HasIndex("BusinessExecutiveId")
                        .HasDatabaseName("ix_customers_businessexecutiveid");
            ...
            modelBuilder.Entity("Xanes.Models.Quotation", b =>
                {
                    ...
                    b.Property<decimal>("AmountCommission")
                        ...
                        .HasDefaultValue(0m)
                        .HasColumnName("amountcommission");
                    ...
                    b.Property<decimal>("AmountCostReal")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)")
                        .HasDefaultValue(0m)
                        .HasColumnName("amountcostreal");
                    ...
                    b.Property<decimal>("AmountRevenueReal")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)")
                        .HasDefaultValue(0m)
                        .HasColumnName("amountrevenuereal");
                    ...
                    b.Property<int?>("BankAccountSourceId")
                        .HasColumnType("int")
                        .HasColumnName("bankaccountsourceid");

                    b.Property<int?>("BankAccountTargetId")
                        .HasColumnType("int")
                        .HasColumnName("bankaccounttargetid");

                    b.Property<string>("BusinessExecutiveCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("businessexecutivecode");
                    ...
                    b.Property<decimal>("ExchangeRateOfficialBase")
                        .HasPrecision(18, 8)
                        .HasColumnType("decimal(18,8)")
                        .HasColumnName("exchangerateofficialbase");
                    ...
                    b.Property<short>("ExchangeRateSourceType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                        .HasDefaultValue((short)1)
                        .HasColumnName("exchangeratesourcetype");
                    ...
                    b.Property<short>("TotalDepositLines")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                        .HasDefaultValue((short)0)
                        .HasColumnName("totaldepositlines");

                    b.Property<short>("TotalLines")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                        .HasDefaultValue((short)0)
                        .HasColumnName("totallines");
                    ...
                    b.Property<short>("TotalTransferLines")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                        .HasDefaultValue((short)0)
                        .HasColumnName("totaltransferlines");
                    ...
                    b.HasIndex("BankAccountSourceId")
                        .HasDatabaseName("ix_quotations_bankaccountsourceid");

                    b.HasIndex("BankAccountTargetId")
                        .HasDatabaseName("ix_quotations_bankaccounttargetid");

                    b.HasIndex("BusinessExecutiveId")
                        .HasDatabaseName("ix_quotations_businessexecutiveid");
            ...
            modelBuilder.Entity("Xanes.Models.QuotationDetail", b =>
                {
                    ...
                    b.Property<Guid?>("BankTransactionTransferFeeId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("banktransactiontransferfeeid");

                    b.Property<Guid?>("BankTransactionTransferFeeVoidId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("banktransactiontransferfeevoidid");
                    ...
                    b.Property<bool>("IsBankTransactionTransferFeePosted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasColumnName("isbanktransactiontransferfeeposted");

                    b.Property<bool>("IsBankTransactionTransferFeeVoidPosted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasColumnName("isbanktransactiontransferfeevoidposted");
                    ...
                    b.Property<bool>("IsJournalEntryTransferFeePosted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasColumnName("isjournalentrytransferfeeposted");

                    b.Property<bool>("IsJournalEntryTransferFeeVoidPosted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false)
                        .HasColumnName("isjournalentrytransferfeevoidposted");
                    ...
                    b.Property<Guid?>("JournalEntryTransferFeeId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("journalentrytransferfeeid");

                    b.Property<Guid?>("JournalEntryTransferFeeVoidId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("journalentrytransferfeevoidid");
                    ...
                    b.Property<decimal>("PercentageCostRevenue")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 6)
                        .HasColumnType("decimal(18,6)")
                        .HasDefaultValue(0m)
                        .HasColumnName("percentagecostrevenue");
            ...
            modelBuilder.Entity("Xanes.Models.BankAccount", b =>
                {
                    b.HasOne("Xanes.Models.Currency", "CurrencyTrx")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_banksaccounts_currencies_currencyid");

                    b.HasOne("Xanes.Models.Bank", "ParentTrx")
                        .WithMany()
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_banksaccounts_banks_parentid");
            ...
            modelBuilder.Entity("Xanes.Models.Customer", b =>
                {
                    b.HasOne("Xanes.Models.BusinessExecutive", "BusinessExecutiveTrx")
                        .WithMany()
                        .HasForeignKey("BusinessExecutiveId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_customers_businessexecutives_businessexecutiveid");
                    ...
                    b.Navigation("BusinessExecutiveTrx");
            ...
            modelBuilder.Entity("Xanes.Models.Quotation", b =>
                {
                    b.HasOne("Xanes.Models.BankAccount", "BankAccountSourceTrx")
                        .WithMany()
                        .HasForeignKey("BankAccountSourceId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_quotations_banksaccounts_bankaccountsourceid");

                    b.HasOne("Xanes.Models.BankAccount", "BankAccountTargetTrx")
                        .WithMany()
                        .HasForeignKey("BankAccountTargetId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_quotations_banksaccounts_bankaccounttargetid");
                    ...
                    b.HasOne("Xanes.Models.BusinessExecutive", "BusinessExecutiveTrx")
                        ...
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_quotations_businessexecutives_businessexecutiveid");
                    ...
                    b.Navigation("BankAccountSourceTrx");

                    b.Navigation("BankAccountTargetTrx");
